        ...
        <div className="flex flex-wrap items-center">
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-17.5 px-26 text-center">
              ...
              <p className="2xl:px-20">
                Welcome back to BlockVest. Please sign in to continue.
              </p>

              <span className="mt-15 inline-block">
                <img src="/images/illustration/illustration-01.svg" alt="illustration" />
              </span>
            </div>
          </div>
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              {error && (
                <div className="mb-6 rounded-lg bg-danger/[0.08] p-4 text-sm text-danger">
                  {error}
                </div>
              )}

              <h2 className="mb-9 text-2xl font-bold text-black dark:text-white sm:text-title-xl2">
                Sign In to BlockVest
              </h2>
                  ...
                  >
                    <div className="relative">
                      ...
                      <div className="box mr-4 flex h-5 w-5 items-center justify-center rounded border border-stroke dark:border-strokedark">
                        <span className={`text-white ${rememberMe ? 'opacity-100' : 'opacity-0'}`}>
                          <svg
